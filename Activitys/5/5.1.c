...
task main()
{
	untilPotentiometerGreaterThan(100,pot);       //Waits Untill Potentiometer Named pot is greater than 100
	startMotor(leftMotor, 127);                   //Start Left Motor Full Speed
	startMotor(rightMotor, 127); 									//Start Right Motor Full Speed
